export const CTASecondaryButton = ({
  ...
  return (
    <div className="flex min-w-[90px] w-full h-[35px] relative group cursor-pointer">
      ...
      <div className="absolute top-1 left-1.5 w-full h-full border border-primaryGray bg-transparent group-hover:bg-primaryGray z-0 transition-all duration-200 ease-in-out" />
    </div>
  );
};
